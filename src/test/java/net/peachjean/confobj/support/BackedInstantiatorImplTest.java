...
public class BackedInstantiatorImplTest {
    ...
    public static class Simple {
        private final ConfigObjectBacker backer;

        public Simple(ConfigObjectBacker backer) {

            this.backer = backer;
        }

        public ConfigObjectBacker getBacker() {
            return backer;
        }
    }
    ...
    public static class Complex {
        ...
        public Complex(ConfigObjectBacker backer, String strDep, Integer intDep) {
            this.strDep = strDep;
            this.intDep = intDep;
        }
    ...
    public static class Annotated {
        ...
        public Annotated(ConfigObjectBacker backer, @Named("first") String first, @Named("second") String second) {
