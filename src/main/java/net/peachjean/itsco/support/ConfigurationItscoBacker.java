...
class ConfigurationItscoBacker<I> implements ItscoBacker<I> {
    ...
    public ConfigurationItscoBacker(Configuration context, Iterable<FieldResolutionStrategy> strategies) {
